...
namespace Infrastructure.Data
{
  ...
  public static class SeedTeams
    {
      public static readonly (string Name, string City, string Stadium, int Capacity, string Color1, string Color2, string Color3)[] NFLTeams =
      {
          ("Arizona Cardinals", "Glendale, Arizona", "State Farm Stadium", 63400, "#97233F", "#FFB612", "#000000"),
          ("Atlanta Falcons", "Atlanta, Georgia", "Mercedes-Benz Stadium", 71000, "#A71930", "#000000", "#A5ACAF"),
          ("Baltimore Ravens", "Baltimore, Maryland", "M&T Bank Stadium", 71000, "#241773", "#000000", "#9E7C0C"),
          ("Buffalo Bills", "Orchard Park, New York", "Highmark Stadium", 71608, "#00338D", "#C60C30", "#FFFFFF"),
          ("Carolina Panthers", "Charlotte, North Carolina", "Bank of America Stadium", 75419, "#0085CA", "#101820", "#BFC0BF"),
          ("Chicago Bears", "Chicago, Illinois", "Soldier Field", 61500, "#0B162A", "#C83803", "#FFFFFF"),
          ("Cincinnati Bengals", "Cincinnati, Ohio", "Paycor Stadium", 65515, "#FB4F14", "#000000", "#FFFFFF"),
          ("Cleveland Browns", "Cleveland, Ohio", "Cleveland Browns Stadium", 67431, "#311D00", "#FF3C00", "#FFFFFF"),
          ("Dallas Cowboys", "Arlington, Texas", "AT&T Stadium", 80000, "#003594", "#041E42", "#869397"),
          ("Denver Broncos", "Denver, Colorado", "Empower Field at Mile High", 76125, "#002244", "#FB4F14", "#FFFFFF"),
          ("Detroit Lions", "Detroit, Michigan", "Ford Field", 65000, "#0076B6", "#B0B7BC", "#000000"),
          ("Green Bay Packers", "Green Bay, Wisconsin", "Lambeau Field", 81441, "#203731", "#FFB612", "#FFFFFF"),
          ("Houston Texans", "Houston, Texas", "NRG Stadium", 72220, "#03202F", "#A71930", "#FFFFFF"),
          ("Indianapolis Colts", "Indianapolis, Indiana", "Lucas Oil Stadium", 67000, "#002C5F", "#A2AAAD", "#FFFFFF"),
          ("Jacksonville Jaguars", "Jacksonville, Florida", "EverBank Stadium", 67838, "#006778", "#000000", "#9F792C"),
          ("Kansas City Chiefs", "Kansas City, Missouri", "Arrowhead Stadium", 76416, "#E31837", "#FFB81C", "#FFFFFF"),
          ("Las Vegas Raiders", "Las Vegas, Nevada", "Allegiant Stadium", 65000, "#000000", "#A5ACAF", "#FFFFFF"),
          ("Los Angeles Chargers", "Inglewood, California", "SoFi Stadium", 70240, "#0080C6", "#FFC20E", "#FFFFFF"),
          ("Los Angeles Rams", "Inglewood, California", "SoFi Stadium", 70240, "#003594", "#FFD100", "#FFFFFF"),
          ("Miami Dolphins", "Miami Gardens, Florida", "Hard Rock Stadium", 65326, "#008E97", "#FC4C02", "#005778"),
          ("Minnesota Vikings", "Minneapolis, Minnesota", "U.S. Bank Stadium", 66655, "#4F2683", "#FFC62F", "#000000"),
          ("New England Patriots", "Foxborough, Massachusetts", "Gillette Stadium", 65878, "#002244", "#C60C30", "#B0B7BC"),
          ("New Orleans Saints", "New Orleans, Louisiana", "Caesars Superdome", 73208, "#D3BC8D", "#101820", "#FFFFFF"),
          ("New York Giants", "East Rutherford, New Jersey", "MetLife Stadium", 82500, "#0B2265", "#A71930", "#FFFFFF"),
          ("New York Jets", "East Rutherford, New Jersey", "MetLife Stadium", 82500, "#125740", "#000000", "#FFFFFF"),
          ("Philadelphia Eagles", "Philadelphia, Pennsylvania", "Lincoln Financial Field", 69596, "#004C54", "#A5ACAF", "#000000"),
          ("Pittsburgh Steelers", "Pittsburgh, Pennsylvania", "Acrisure Stadium", 68400, "#FFB612", "#101820", "#FFFFFF"),
          ("San Francisco 49ers", "Santa Clara, California", "Levi's Stadium", 68500, "#AA0000", "#B3995D", "#FFFFFF"),
          ("Seattle Seahawks", "Seattle, Washington", "Lumen Field", 68000, "#002244", "#69BE28", "#A5ACAF"),
          ("Tampa Bay Buccaneers", "Tampa, Florida", "Raymond James Stadium", 65890, "#D50A0A", "#34302B", "#000000"),
          ("Tennessee Titans", "Nashville, Tennessee", "Nissan Stadium", 69143, "#4B92DB", "#0C2340", "#A2AAAD"),
          ("Washington Commanders", "Landover, Maryland", "FedExField", 82000, "#5A1414", "#FFB612", "#000000")
      };

      public static readonly (string Name, string City, string Stadium, int Capacity, string Color1, string Color2, string Color3)[] NBATeams =
      {
