...
namespace Application.Votes.Commands.EmailRewardRedemption
{
    public class EmailRewardRedemptionHandler : IRequestHandler<EmailRewardRedemptionCommand, ServiceResponse<string>>
    {
        ...
        public EmailRewardRedemptionHandler(IRepository repo, IMapper mapper, IRewardRedemptionService rewardService, IEventPublisher publisher, IUserDirectory userDirectory)
        {
            _repo = repo;
            _mapper = mapper;
