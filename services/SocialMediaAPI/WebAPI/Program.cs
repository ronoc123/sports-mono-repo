...
builder.WebHost.ConfigureKestrel(opts =>
    opts.Limits.MaxRequestBodySize = 2L * 1024 * 1024 * 1024);
...
// Load RSA public key — shared key issued by IdentityService
// Place the public.pem file from IdentityService/Keys/ into WebAPI/Keys/
