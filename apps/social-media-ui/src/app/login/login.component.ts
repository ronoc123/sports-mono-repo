...
@Component({
  ...
  styles: [`
    ...
    .logo p { color: #8b8fa8; font-size: 0.85rem; margin: 0; }
    ...
    .form-group input:focus { outline: none; border-color: #818cf8; }
    .form-group input::placeholder { color: #4a4d5e; }
    ...
    .footer-text strong { color: #818cf8; }
  `],
  template: `
    <div class="page">
      <div class="card">
        <div class="logo">
          ...
          <p>AI-powered video publishing</p>
        </div>
        ...
        <form (ngSubmit)="onSubmit()">
          ...
          @if (mode() === 'register') {
            <div class="form-group">
              ...
              <input type="password" [(ngModel)]="confirmPassword" name="confirmPassword" placeholder="••••••••" />
            </div>
          }
        ...
        <div class="footer-text">
          <strong>Social Media AI</strong> · Powered by sports-mono-repo
        </div>
      </div>
    </div>
  `,
...
export class LoginComponent {
  ...
  async onSubmit() {
    ...
    try {
      ...
      this.error.set(
        (e as { message?: string })?.message ?? 'Authentication failed. Please try again.'
      );
    } finally {
